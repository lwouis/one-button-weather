...
//        cityTextField.translatesAutoresizingMaskIntoConstraints = false
    ...
    private func fetchMatchingCities(_ query: String) async -> String? {
        ...
        let searchUrl = URL(string: "https://www.meteoblue.com/en/server/search/query3?callback=jQuery36003211564491202923_1706997521805&query=\(searchQuery)&orderBy=&itemsPerPage=10&page=1")!
    ...
    private func fetchImageUrl(_ cityUrl: String) async -> String? {
        let url = URL(string: "https://www.meteoblue.com/en/weather/week/\(cityUrl)")!
